...
// import options from '../options.js'; #TODO: A file where you can configure files, would be ver yusefull for making settings
...
class PopupWindow2 extends AgsWindow {
    ...
    constructor({ name, child, transition = 'none', visible = false, ...rest }) {
        ...
        this.revealer = Widget.Revealer({
            transition,
            child,
            transitionDuration: 200, //options.transition.value,

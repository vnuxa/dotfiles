...
in{
    ...
    windowrule = [
        ...
        # "opacity 0.975, title:^(nvim)$" #pointless because kitty blurs it itself
        "opacity 0.9, libreoffice-calc"

        "move 0 150, initialtitle:^(notificationtoasts)(.*)$" #fix steam notification popups below bar
    ];

    exec-once = [
        "[workspace 1 silent] firefox"
        "[workspace 2 silent] armcord --enable-blink-features=MiddleClickAutoscroll"

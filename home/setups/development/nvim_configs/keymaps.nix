{
  ...
  # Neo term
  normal."<leader>tt" = {
    action = "':NeoTermToggle'";
    desc = "Toggle terminal";
    silent = true;
  };

  normal."<leader>to" = {
    action = "':NeoTermEnterNormal'";
    desc = "Terminal open";
    silent = true;
  };
  ...
  # normal."<leader>w" = { desc = "Workspaces"; };
  normal."<leader>wa" = {
    action = "':WorkspacesAdd '";
    desc = "Add current directory to workspaces";
  };
  normal."<leader>wr" = {
    action = "':WorkspacesRemove '";
    desc = "Remove specified workspace";
  };
  normal."<leader>wn" = {
    action = "':WorkspacesRename '";
    desc = "Rename a specified workspace to a new one";
  };
  normal."<leader>ws" = {

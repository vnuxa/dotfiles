{ pkgs, config, firefox-addons, ... }: let
    SilentFox = pkgs.fetchFromGitHub {
        owner = "linuxmobile";
        repo = "SilentFox";
        rev = "621c66ddd82eb5c25edb7ce1d0099c61ba937b88";
        sha256 = "sha256-3VTJCJ04Kn5wOklb6x5JxL54kcBEmsH2JQcUqE7negI=";
    };
in {
    programs.firefox = {
        enable = true;

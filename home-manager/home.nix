...
{ 
  ...
  imports  = [
    ...
    ./setups/gaming/main.nix
    ./setups/gaming/gaming-scripts.nix
    ./setups/spicetify.nix
    ./setups/hyprland/hyprland.nix
    ./setups/hyprland/hyprland_scripts.nix
    ./setups/themes.nix
    ./setups/shell/terminals.nix
    ./setups/shell/nushell.nix
    ./setups/theme_configurations.nix
    ./setups/fish.nix
    ./setups/firefox/browser.nix
    ./setups/file-sharing.nix
  ...
  home.packages = with pkgs; [
    # (callPackage ./setups/gaming/vinegar.nix {}) #INFO: pointless, need a VM to run it now
    # (callPackage ./setups/moosync/moosync-yarn.nix {}) 
    # (callPackage ./setups/gaming/mod-integration-drg.nix { naersk = naersk; }) #FIXME: check every oncei na while if things have been fixed
    # pkgs.hello
    r2modman
    stremio
    # Web & media
